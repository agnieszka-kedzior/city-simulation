...
import ieee1516e.SamochodFED.SamochodFederatAmbassador;
...
public class MostFederat {
    ...
    private MostFederatAmbassador fedamb;  // created when we connect
    private HLAfloat64TimeFactory timeFactory; // set when we join
    protected EncoderFactory encoderFactory;     // set when we join

    // caches of handle types - set once we join a federation - delete
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            new MostFederat().runFederate(federateName);
