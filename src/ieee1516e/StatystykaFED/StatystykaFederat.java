...
public class StatystykaFederat {
    //----------------------------------------------------------
    //                    STATIC VARIABLES
    //----------------------------------------------------------
    ...
    private StatystykaFederatAmbassador fedamb;  // created when we connect
    ...
    public void runFederate(String federateName) throws Exception {
        ...
        // connect
        log("Connecting...");
        fedamb = new StatystykaFederatAmbassador(this);
        ...
        try {
            rtiamb.destroyFederationExecution("StatystykaFederation");
    ...
    public static void main(String[] args) {
        ...
        try {
            new StatystykaFederat().runFederate(federateName);
